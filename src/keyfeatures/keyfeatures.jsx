                ...
                >
                    ...
                    <SwiperSlide >
                        <div className='card-1' >
                            <img className='card-img' src="./src/assets/three-stars.svg" alt="" />
                    ...
                    <SwiperSlide>
                        <div className='card-1'>
                            <img className='card-img' src="./src/assets/thunderstorm.svg" alt="" />
                    ...
                    <SwiperSlide>
                        <div className='card-1'>
                            <img className='card-img' src="./src/assets/tower.svg" alt="" />
                    ...
                    <SwiperSlide>
                        <div className='card-1'>
                            <img className='card-img' src="./src/assets/timer.svg" alt="" />
                    ...
                    <SwiperSlide>
                        <div className='card-1'>
                            <img className='card-img' src="./src/assets/light-conversion.svg" alt="" />
                    ...
                    <SwiperSlide>
                        <div className='card-1'>
                            <img className='card-img' src="./src/assets/link.svg" alt="" />
